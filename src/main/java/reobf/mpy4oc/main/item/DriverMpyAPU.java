...
/**
 * Driver for {@link ItemMpyAPU}. Makes the APU behave as an mpy CPU (fixed
 ...
 */
public class DriverMpyAPU implements Processor, CallBudget {

    @Override
    public boolean worksWith(ItemStack stack) {
        return stack != null && stack.getItem() instanceof ItemMpyAPU;
    }
    ...
    public int supportedComponents(ItemStack stack) {
        return stack != null && stack.getItem() instanceof ItemMpyAPU
                ? ((ItemMpyAPU) stack.getItem()).supportedComponents(stack)
                : 8;
    }
    ...
    public double getCallBudget(ItemStack stack) {
        return stack != null && stack.getItem() instanceof ItemMpyAPU
                ? ((ItemMpyAPU) stack.getItem()).callBudget(stack)
                : 1.0;
    }
    ...
    public int tier(ItemStack stack) {
        return stack != null && stack.getItem() instanceof ItemMpyAPU
                ? ((ItemMpyAPU) stack.getItem()).tierOf(stack)
                : 0;
    }
    ...
    public ManagedEnvironment createEnvironment(ItemStack stack, EnvironmentHost host) {
        int tier = stack != null && stack.getItem() instanceof ItemMpyAPU
                ? ((ItemMpyAPU) stack.getItem()).tierOf(stack)
                : 0;
        try {
            return new MpyApuComponent(tier, host);
        } catch (Throwable t) {
