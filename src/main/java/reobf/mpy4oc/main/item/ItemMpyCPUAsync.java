 ...
 */
public class ItemMpyCPUAsync extends Item {
    ...
    public ItemMpyCPUAsync() {
        super();
        setMaxStackSize(64);
        setHasSubtypes(true);
        setMaxDamage(0);
        setUnlocalizedName("mpy4oc.cpu.async");
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List tooltip, boolean advanced) {
        ...
        tooltip.add(net.minecraft.util.StatCollector.translateToLocal("mpy4oc.tip.cpu.async.arch"));
        ...
        tooltip.add(net.minecraft.util.StatCollector.translateToLocal("mpy4oc.tip.cpu.async.desc"));
    }
    ...
    public void registerIcons(IIconRegister reg) {
        ...
        for (int t = 0; t < TIERS; t++) {
            ...
            icons[t] = reg.registerIcon("mpy4oc:mpy_cpu_async" + (t == 0 ? "" : String.valueOf(t + 1)));
        }
    }
